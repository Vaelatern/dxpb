...
/*  These are the pkggraph_msg messages:
    ...
    ICANHELP -
        ...
        cost                number 2    This should be 100 unless the builder is expensive or slow enough to warrant a lower priority when handing out work. If it's just really fast, then more builders are the answer, not a negative cost.
        addr                number 2
        check               number 4
